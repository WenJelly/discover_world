...
func buildDirectUploadAssetResponse(ctx context.Context, svcCtx *svc.ServiceContext, session *mediamodel.MediaUploadSession, viewer *accountmodel.UserAccount) (*types.MediaAssetResponse, error) {
